...
public class Criminal {
		...
		String criminal_type;
		  ...
		  @JoinTable( name="FIR_Criminal", joinColumns= {@JoinColumn(name="fir_id")},
		  inverseJoinColumns= {@JoinColumn(name="criminal_id")} ) Set<FIR> fir=new
		  HashSet<>();
		...
		public Criminal(String id, String criminal_name, String offence_id, String fir_id, int age,
		...
		public String toString() {
			return "Criminal [id=" + id + ", criminal_name=" + criminal_name + ", offence_id="
