...
public class FIR {
	...
	public Set<Offence> getOff() {
		return off;
	}

	public void setOff(Set<Offence> off) {
		this.off = off;
	}

	public Set<Criminal> getCr() {
		return cr;
	}

	public void setCr(Set<Criminal> cr) {
		this.cr = cr;
	}
	...
	@ManyToMany(mappedBy="firlist")
	private Set<Offence> off=new HashSet<>();
	
	@ManyToMany(mappedBy="fir")
	private Set<Criminal> cr=new HashSet<>();
